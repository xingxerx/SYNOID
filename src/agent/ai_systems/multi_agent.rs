...
use crate::agent::ai_systems::reasoning::{ReasoningEffort, ReasoningManager};
...
use crate::agent::ai_systems::gpt_oss_bridge::SynoidAgent; // Imported for real LLM calls
