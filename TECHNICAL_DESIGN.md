...
*   **High-End Specification (Intel i9 7900X):** Utilizes a 10-core/20-thread architecture to maximize parallelization during "Image Generation" and "Quality Optimization". Allows simultaneous rendering and background indexingxerx without frame drops.
